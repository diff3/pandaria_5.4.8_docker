...
auth_04_03_2023.sql
mysql -u $MYSQL_USERNAME -p$MYSQL_PASSWORD archive < /opt/etc/pandaria_5.4.8/sql/base/archive_04_03_2023.sql
mysql -u $MYSQL_USERNAME -p$MYSQL_PASSWORD auth < /opt/etc/pandaria_5.4.8/sql/base/auth_04_03_2023.sql
mysql -u $MYSQL_USERNAME -p$MYSQL_PASSWORD characters < /opt/etc/pandaria_5.4.8/sql/base/characters_04_03_2023.sql
mysql -u $MYSQL_USERNAME -p$MYSQL_PASSWORD world < /opt/etc/pandaria_5.4.8/sql/base/world_04_03_2023.sql
